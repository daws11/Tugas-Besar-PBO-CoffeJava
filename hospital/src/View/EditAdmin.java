...
public class EditAdmin extends javax.swing.JFrame {
    ...
    public EditAdmin(Admin admin) {
        ...
        jTextField6.setText(admin.getFirstName());
        jTextField7.setText(admin.getLastName());
        jTextField8.setText(admin.getEmail());
        jTextField9.setText(admin.getPhoneNumber());
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(628, 425));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            this.adminController.editAdmin(this.admin.getAdminId(), firstName, lastName, email, phoneNumber);
            JOptionPane.showMessageDialog(null, "edit admin successful!", "Success", JOptionPane.INFORMATION_MESSAGE);
