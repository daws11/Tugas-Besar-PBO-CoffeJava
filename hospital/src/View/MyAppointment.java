 ...
 * @author adibf
 */
public class MyAppointment extends javax.swing.JDialog {

    /**
     * Creates new form MyAppointment
     */
    public MyAppointment(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MyAppointment dialog = new MyAppointment(new javax.swing.JFrame(), true);
