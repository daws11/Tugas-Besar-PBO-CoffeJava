 ...
 * @author adibf
 */
public class DoctorAppointment extends javax.swing.JDialog {

    /**
     * Creates new form DoctorSchedule
     */
    public DoctorAppointment(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Filter by Specialization");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DoctorAppointment dialog = new DoctorAppointment(new javax.swing.JFrame(), true);
