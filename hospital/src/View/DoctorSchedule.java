 ...
 * @author adibf
 */
public class DoctorSchedule extends javax.swing.JDialog {

    /**
     * Creates new form DoctorSchedule
     */
    public DoctorSchedule(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DoctorSchedule dialog = new DoctorSchedule(new javax.swing.JFrame(), true);
